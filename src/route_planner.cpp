...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
  // Find neighbors of the current_node, this populates current_node.neighbors vector
  ...
  for ( auto node : current_node->neighbors)
  {
    ...
    // Is this right? Or should this be n->g_value = node->distance(*current_node) + current_node->g_value;? 
